        ...
        <Row>
          ...
          <Col xs={1} sm={1} md={2} lg={4}>
            <div className="new-arrival-banner">
              <div className="new-arrival-banner-heading">#New Arrivals</div>
              <div className="new-arrival-banner-description">
                <p>
                  Explore our new trend collection of effortlessly elegant
                  dresses. From flowing silhouettes to tailored designs, each
                  piece embodies grace and versatility
                </p>
              </div>
              <div className="new-arrivals-banner-button">
                <Button variant="dark" onClick={shopnowbuttonhandler}>
                  Shop Now
                </Button>
              </div>
            </div>
