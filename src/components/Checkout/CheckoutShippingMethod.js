      ...
      <Form className="shipping-method-form">
        <Row className="mb-3">
          <Col xs="8" lg="8" sm="8" md="9">
            <Form.Group controlId="formGridTitleSAT">
              <Form.Check
                ...
                type="radio"
                label="SATURDAY DELIVERY OPTION"
                id="SAT"
                name="shipping-method"
                required
                ref={satDelivery}
                onClick={satRadioClickHandler}
              />
            </Form.Group>
          </Col>
          <Col xs="4" lg="4" sm="4" md="3">
            <p>
              INR&nbsp;
              {parseFloat(Constants.satDeliveryPrice).toFixed(2).toString()}
            </p>
          </Col>
        </Row>
        <Row className="mb-3">
          ...
          <Col xs="4" lg="4" sm="4" md="3">
            <p>
              INR&nbsp;
              {parseFloat(Constants.stdDeliveryPrice).toFixed(2).toString()}
            </p>
          </Col>
        </Row>
      </Form>
